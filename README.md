# A02 - Internal Memory Management in GCC During Compilation

This repository documents the research into GCC's memory allocation strategies, including GGC (Garbage Collection), Obstacks, and memory pools.
